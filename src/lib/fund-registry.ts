...
export const FUND_REGISTRY: {
  ...
  { symbol: "BND", label: "Vanguard Total Bond Market", aliases: ["total bond", "inst total bond", "institutional total bond", "bond market", "bond fund", "bnd", "vbtlx", "fxnax", "m089", "aggregate bond", "total bond market"] },
  { symbol: "VOO", label: "Vanguard S&P 500 / Inst 500", aliases: ["inst 500", "institutional 500", "500 index", "500 ldxtr", "s and p 500", "s&p 500", "sp 500", "voo", "vfiax", "fxaix", "m077", "vanguard 500"] },
  { symbol: "VXUS", label: "Vanguard Total International", aliases: ["total international", "total intl", "inst total intl", "institutional total international", "international stock", "international stock market", "itub", "vxus", "vtiax", "vtsnx", "v016", "ex us", "ex-us"] },
  { symbol: "DFAT", label: "DFA Targeted Value", aliases: ["dfa targeted value", "dfa target value", "targeted value", "dfat", "dffvx", "dtvlx", "dimensional targeted value"] },
  { symbol: "VMFXX", label: "Vanguard Money Market / Stable Value", aliases: ["retirement savings trust", "retire savings trust", "retire savings", "stable value", "money market", "vmfxx", "spaxx", "cash fund", "savings trust"] },
